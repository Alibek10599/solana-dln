...
export async function insertOrderEvents(events: OrderEvent[]): Promise<number> {
  ...
  const rows = events.map(e => ({
    ...
    give_chain_id: (e.give_chain_id !== null && e.give_chain_id !== undefined && e.give_chain_id <= MAX_UINT64) ? Number(e.give_chain_id) : null,
    ...
    take_chain_id: (e.take_chain_id !== null && e.take_chain_id !== undefined && e.take_chain_id <= MAX_UINT64) ? Number(e.take_chain_id) : null,
